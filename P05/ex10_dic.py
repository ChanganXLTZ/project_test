...
print('转换成字符串',str(dict1)[:7]) # 输出字典，以可打印的字符串表示。
print(type(str(dict1)))
print('装换成数组',list(dict1))
...
print(dict1.values())
print()
print(dict1.setdefault('daughter')) # 查找该键的值，不存在则存入None
print(list(dict1.items())) # list(dict1.items())[0][0]
dict3.update(dict2) # 更新，把字典dict2的键/值对更新到dict里,添加元素
print(dict3.items())
#  删除 
